...
export default function Banner() {
  return (
    <section className="relative flex items-center justify-center mx-3" >
        <div className="">
        ...
        <div className="absolute top-0 left-0 w-full h-full flex items-center justify-center m-2">
