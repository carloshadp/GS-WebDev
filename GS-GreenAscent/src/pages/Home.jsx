...
export default function Home() {
  return (
    <>
      <section className="flex flex-col w-full min-h-screen pt-52  desktop:py-10 desktop:pt-0 gap-12 items-center bg-gradient-to-b from-verde-normal via-green-950 to-verde-normal">
        <Banner/>

        <div className="flex flex-col w-full px-5 max-w-[960px]">
